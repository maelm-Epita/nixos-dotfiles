{pkgs,...}: {
    programs.hyprpanel = {
        ...
        settings = {
            ...
            theme.font.label = "Noto Sans CJK SC Medium";
            ...
            menus.media.noMediaText = "welcome :)";
            theme.osd.orientation = "horizontal";
            theme.osd.location = "bottom";
            theme.osd.scaling = 95;
            theme.osd.radius = "0.4em";
            theme.osd.margins = "2px 2px 10px 2px";
            menus.volume.raiseMaximumVolume = false;
            bar.clock.icon = "";
            menus.dashboard.powermenu.avatar.image = "/home/mael/Images/autre/hatsuneuserpfp.jpg";
            ...
            theme.bar.menus.background = "#111111";
            ...
            theme.bar.menus.popover.background = "#241f31";
            ...
            theme.bar.menus.iconbuttons.passive = "#3d3846";
            theme.bar.menus.buttons.text = "#241f31";
            ...
            theme.notification.close_button.background = "#1a1a1a";
            ...
            theme.bar.buttons.icon_background = "#111111";
